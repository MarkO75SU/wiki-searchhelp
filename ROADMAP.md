...
* **🌐 Netzwerkgraph 2.0:** Wiederhergestellt und für alle Nutzer verfügbar (Thematische Cluster-Analyse). [x]
...
* **Admin Board Pro:** Monitoring via Chart.js & Supabase Edge (Expert Tier). [x]
...
* **Mobile-App:** Finalisierung für Tauri/Capacitor Wrapper.